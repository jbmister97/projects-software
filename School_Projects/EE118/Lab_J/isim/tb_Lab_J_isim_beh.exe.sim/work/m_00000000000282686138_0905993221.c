...
#endif
static const char *ng0 = "C:/Users/Justin/Lab_J/Lab_J.v";
...
LAB46:    t7 = ((char*)((ng1)));
    t6 = xsi_vlog_unsigned_case_compare(t5, 2, t7, 2);
    if (t6 == 1)
        goto LAB47;
...
LAB25:    if (*((unsigned int *)t7) < *((unsigned int *)t8))
        goto LAB24;
...
LAB30:    xsi_set_current_line(58, ng0);
    ...
    t7 = ((char*)((ng2)));
    memset(t16, 0, 8);
    xsi_vlog_unsigned_add(t16, 5, t5, 5, t7, 5);
    t8 = (t0 + 3368);
    xsi_vlogvar_assign_value(t8, t16, 0, 0, 5);
...
LAB40:    if (*((unsigned int *)t7) < *((unsigned int *)t8))
        goto LAB39;
...
extern void work_m_00000000000282686138_0905993221_init()
{
	static char *pe[] = {(void *)Always_27_0,(void *)Always_40_1,(void *)Cont_116_2,(void *)Cont_117_3,(void *)Cont_118_4,(void *)Cont_119_5,(void *)Cont_120_6,(void *)Cont_121_7};
	xsi_register_didat("work_m_00000000000282686138_0905993221", "isim/tb_Lab_J_isim_beh.exe.sim/work/m_00000000000282686138_0905993221.didat");
